...
const AddDigitalProduct = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!token) {
        setError('You must be logged in to add products. Please log in and try again.');
      ...
      const response = await fetch('http://192.168.43.102:8000/api/digital-products', {
        method: 'POST',
        headers: {
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200/50 p-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Add New Digital Product</h1>
            </div>
