  ...
  return (
    <div className="w-20 bg-white flex flex-col items-center py-6 h-[calc(100vh-64px)]">
      ...
      <div className="flex flex-col gap-6 items-center text-gray-400">
        <LayoutDashboard className="w-5 h-5 hover:text-[#00796B] cursor-pointer" />
        <Link to="/store">
          <ShoppingCart className="w-5 h-5 hover:text-[#00796B] cursor-pointer" />
        </Link>  
        <Link to="/users">
        <ClipboardList className="w-5 h-5 hover:text-[#00796B] cursor-pointer" />
        </Link>
        <Settings className="w-5 h-5 hover:text-[#00796B] cursor-pointer" />
      </div>
