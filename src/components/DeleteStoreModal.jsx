    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6 z-10">
        ...
        <div className="flex items-start mb-4">
          ...
          <div className="ml-3">
            <h3 className="text-lg font-bold text-gray-900">Delete Medical Store</h3>
            <p className="text-gray-600 mt-1">
              Are you sure you want to permanently delete <span className="font-semibold">{storeName}</span>?
            </p>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-red-700">
                This will permanently remove all store data, including products and inventory. 
